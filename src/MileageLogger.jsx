...
export default function MileageLogger() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col relative" style={{ fontFamily: "'Manrope', sans-serif" }}>
      ...
      <div className="relative z-10 flex flex-col min-h-screen bg-slate-950">
        <Header lastMileage={lastMileage} lastMileageMeta={lastMileageMeta} activeTrip={activeTrip} />

        <main className="flex-1 overflow-y-auto pb-24 px-4 pt-4 no-scrollbar bg-slate-950">
          {tab === "log" && (
            <LogTab
...
function Header({ lastMileage, lastMileageMeta, activeTrip }) {
  return (
    <div className="px-5 pt-6 pb-5 border-b border-slate-800 bg-slate-950">
      <div className="flex items-center justify-between mb-3">
        ...
        {activeTrip && (
          <div className="flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-emerald-950 border border-emerald-500">
...
function TripRow({ trip, onClick, compact }) {
  ...
  return (
    <button
      onClick={onClick}
      className="w-full text-left rounded-xl bg-slate-900 hover:bg-slate-800 border border-slate-800 p-3 flex items-center gap-3 transition-colors"
    >
...
function Modal({ title, onClose, children, footer }) {
  return (
    <div className="fixed inset-0 z-50 flex items-end justify-center bg-black" onClick={onClose}>
      <div
...
function ConfirmDialog({ title, message, onCancel, onConfirm }) {
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black px-6" onClick={onCancel}>
